...
When your output names a domain concept, use the term as defined in `CONTEXT.md`. If the concept you need isn't in the glossary yet, note that gap for `/domain-modeling`.
